    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-3 mb-4 wow animate__fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.7s">
                ...
                <ul class="contacto">
                    <li>
                        <a href="https://wa.link/b13x2v"><img src="{{ asset('/img/icons/icon-contacto-whatsapp.svg') }}" alt="icono de whatsapp">0971643957</a>
                    </li>
                    <li>
                        <a href="mailto:puntocodepy@gmail.com"><img src="{{ asset('/img/icons/icon-contacto-gmail.svg') }}" alt="icono de gmail">puntocodepy@gmail.com</a>
                    </li>
                    <li>
                        <a href="mailto:puntocodepy@gmail.com"><img src="{{ asset('/img/icons/icon-contacto-mail.svg') }}" alt="icono de email">info@puntocode.com.py</a>
                    </li>
                    <li>
                        <a href="https://goo.gl/maps/R9k67jf7pJyY3i2B8"><img src="{{ asset('/img/icons/icon-contacto-map.svg') }}" alt="icono de direccion">14 de Mayo 514 c/ Juan Centurión</a>
                    </li>
                </ul>
            </div>
